...
drop table if exists owner;
			create table owner(
					...
					owner_communication_address_line_1 varchar(255),
					owner_communication_address_line_2 varchar(255),
					owner_communication_address_line_3 varchar(255),
					owner_communication_address_city varchar(50),
					owner_communication_address_state varchar(50),
					owner_communication_address_country varchar(50),
					owner_communication_address_pincode varchar(50),
					owner_communication_address_telephone varchar(50),
					owner_communication_address_mobile_primary varchar(50),
					owner_communication_address_mobile_alternate varchar(50),
					owner_communication_address_email_primary varchar(100),
					owner_communication_address_email_alternate varchar(100),
					owner_photo_file_id varchar(255),
					primary key (owner_id,flat_number,owner_communication_address_mobile_primary));
drop table if exists tenant;
			create table tenant(
					...
					tenant_dob date,
					flat_number varchar(50),
					tenant_status varchar(10),
					tenancy_start_date date,
					tenancy_end_date date,
					tenant_communication_address_line_1 varchar(255),
					tenant_communication_address_line_2 varchar(255),
					tenant_communication_address_line_3 varchar(255),
					tenant_communication_address_city varchar(50),
					tenant_communication_address_state varchar(50),
					tenant_communication_address_country varchar(50),
					tenant_communication_address_pincode varchar(50),
					tenant_communication_address_telephone varchar(50),
					tenant_communication_address_mobile_primary varchar(50),
					tenant_communication_address_mobile_alternate varchar(50),
					tenant_communication_address_email_primary varchar(100),
					tenant_communication_address_email_alternate varchar(100),
					tenant_photo_file_id varchar(255),
					primary key (tenant_id,flat_number,tenant_communication_address_mobile_primary));
